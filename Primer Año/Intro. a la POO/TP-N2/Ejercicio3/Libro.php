...
class Libro {
    ...
    {
        return "El libro es " . $this->getTitulo() . ", su ISBN es " . $this->getISBN() . "\n" .
                "Su autor es " . $this->getNombreAutor() . " " . $this->getApellidoAutor() . "\n" .
                "El año de edición fue en el " . $this->getanioEdicion() . ", y su editorial " . $this->getEditorial() . "\n" .
                "Contiene alrededor de " . $this->getCantPaginas() . " páginas" . "\n" .
