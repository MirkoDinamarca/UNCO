...
class CuentaBancaria {
    ...
    public function __construct($numeroCuenta, $saldoActual, $interesAnual)
    {
    ...
    {
        return "Su número de cuenta es " . $this->getNumCuenta() . 
                ", su DNI es " . $this->getdniCliente() . 
                ", posee un saldo actual de $" . $this->getSaldoActual() . ", con un interés anual de $" . $this->getInteresAnual();
    }
}